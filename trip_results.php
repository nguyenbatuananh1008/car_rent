    ...
    <style>
        .model_pg1i {
            overflow: hidden;
            max-height: 475px;
            /* Trạng thái collapsed: nếu nội dung nhỏ hơn 450px, nó vẫn hiển thị đúng */
        ...
        .segment-list {
            max-height: 100px;
            /* Đặt chiều cao tối đa cho vùng danh sách, có thể điều chỉnh */
            overflow-y: auto;
            /* Cho phép cuộn dọc */
            padding: 0;
                                                    ...
                                                    <div class="model_pg1i3 row mt-4 mb-4">
                                                        <div class="col-md-3 col-sm-6">
                                                            ...
                                                            <div class="model_pg1i3l ">
                                                                <h5>
                                                                    <i class="fa-solid fa-clock col_oran me-1"></i><svg
