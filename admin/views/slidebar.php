            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="C_house.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-bus"></i></div>Nhà xe
                            </a>
                            <a class="nav-link" href="Car.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-van-shuttle"></i></div>Xe
                            </a>
                            <a class="nav-link" href="city.php">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-city"></i></div>Thành phố
                            </a>
                        </nav>
                    </div>
                    ...
                    <a class="nav-link" href="route_stop.php">
                        <div class="sb-nav-link-icon"><i class="fa-solid fa-map-marker"></i></div>
                        Điểm dừng
                    </a>
                    <a class="nav-link" href="trip_prices.php">
