                                    ...
                                    <div class="model_pg1i clearfix">
                                        ...
                                        <div class="model_m p-3 clearfix border-top-0 text-center">
                                            ...
                                            <div class="model_pg1i2 row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="model_pg1i2l">
                                                        ...
                                                        <p><?= htmlspecialchars($trip['car_name']) ?>-<?= htmlspecialchars($trip['car_capacity']) ?>chỗ
                                                        </p>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="model_pg1i2r text-end">
                                                        <h3 class="mb-1"><i class=" col_oran"></i>
                                                            <?= number_format($trip['price'], 0) ?> đ</h3>
                                            ...
                                            <div class="model_pg1i3 row mt-4 mb-4 ">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="model_pg1i3l text-end">
                                                        <h6 class="mb-0 mt-3"><i class="fa fa-female col_oran me-1"></i>Còn
                                            ...
                                            <div class="model_pg1i4 row text-center mt-4">
                                                <p>*Vé chặng thuộc chuyến ngày <?= htmlspecialchars($date) ?>
                                                    <?= htmlspecialchars($trip['city_from_name']) ?> -
                                                    <?= htmlspecialchars($trip['city_to_name']) ?></p>
                                                <div class="col-md-12">
                                                    <h6 class="mb-0">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <input type="hidden" name="id_trip"
                                                                        value="<?= htmlspecialchars($trip['id_trip']) ?>">
                                                                    <div class="pickup-locations overflow-auto"
                                                                        style="max-height: 300px;">
                                                                        <?php foreach ($trip['pickup_locations'] as $location): ?>
                                                                            <div class="form-check mb-3">
                                                                                <input class="form-check-input" type="radio"
                                                                                    name="pickup_location"
                                                                                    id="pickup_<?= $location['id_location'] ?>"
                                                                                    value="<?= $location['id_location'] . '|' . $location['time'] . '|' . $location['name_location'] ?>"
                                                                                    required>
                                                                                <label class="form-check-label"
                                                                                    for="pickup_<?= $location['id_location'] ?>">
                                                                                    <strong><?= htmlspecialchars($location['time']) ?></strong>
                                                                                    -
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="dropoff-locations overflow-auto"
                                                                        style="max-height: 300px;">
                                                                        <?php foreach ($trip['dropoff_locations'] as $location): ?>
                                                                            <div class="form-check mb-3">
                                                                                <input class="form-check-input" type="radio"
                                                                                    name="dropoff_location"
                                                                                    id="dropoff_<?= $location['id_location'] ?>"
                                                                                    value="<?= $location['id_location'] . '|' . $location['time'] . '|' . $location['name_location'] ?>"
                                                                                    required>
                                                                                <label class="form-check-label"
                                                                                    for="dropoff_<?= $location['id_location'] ?>">
                                                                                    <strong><?= htmlspecialchars($location['time']) ?></strong>
                                                                                    -
                                                                                    <?= htmlspecialchars($location['name_location']) ?>
                                                                                </label>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" id="ticket_quantity"
                                                                            name="ticket_quantity" class="form-control" min="1"
                                                                            max="<?= htmlspecialchars($trip['remaining_seats']) ?>"
                                                                            placeholder="Nhập số lượng vé" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
