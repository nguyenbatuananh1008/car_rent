...
$city_from = isset($_GET['city_from']) ? $_GET['city_from'] : '';
$city_from_name = isset($_GET['city_from_name']) ? $_GET['city_from_name'] : '';
$city_to = isset($_GET['city_to']) ? $_GET['city_to'] : '';
            ...
            <div class="row booking_2 align-items-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="booking_2i">
                        ...
                        <input class="form-control" type="date" name="date" value="<?= htmlspecialchars($date) ?>" required min="<?= date('Y-m-d') ?>">
